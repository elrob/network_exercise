...
class Router {
 ...
 private:
  ...
  /* shortest_route_fwd_address(...) searches the Router's routing table
     for the shortest route to Host destination 'dest'. It returns the
     integer address of the first address in the shortest route as the
     forwarding address. */

  int shortest_route_fwd_address( int dest );
